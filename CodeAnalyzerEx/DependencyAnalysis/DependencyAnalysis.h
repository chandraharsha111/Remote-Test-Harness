...
public:
	...
	DependencyTable depResult;
	std::unordered_map<std::string, std::vector<std::string>> DependencyAnalysistable(TypeTable& tt,std::string& s);
	
	//std::unordered_map<std::string, std::vector<std::string>>& getMap() { return depResult; }
